...
const InputSelect = ({handleValueChange, defaultValue}) => {
    return (
        <>
            <div class="mb-3">
              <label for="" class="form-label">Choisissez le parcours à afficher:</label>
              <select class="form-select" name="nom-parcours" id="" aria-label="City" onChange={handleValueChange} defaultValue = {defaultValue}>
